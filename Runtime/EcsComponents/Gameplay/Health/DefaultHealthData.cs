...
namespace StormiumTeam.GameBase.Components
{
	public struct DefaultHealthData : IComponentData
	{
		...
		public class SynchronizeSnapshot : ComponentSnapshotSystemDelta<DefaultHealthData, Snapshot>
		{
			public override ComponentType ExcludeComponent => typeof(Exclude);
		}

		public class Update : ComponentUpdateSystemDirect<DefaultHealthData, Snapshot>
		{
		}
